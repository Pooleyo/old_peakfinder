...
# is described by a composite function. These 
# composite functions are made up of smaller unit
# functions; unit functions are accompanied by unit 
# tests, found in the testmodule.py file. 
#
# Unit functions are in the upper section of this
# file. Composite functions are in the lower section.
# 
#####################################################
# Unit functions.
