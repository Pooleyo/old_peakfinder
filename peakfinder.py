...
gsqr_est, pos_est = mod.make_fcc(gsqr_max = 10, negative_k = True, remove_000 = True)
...
md_temperature_2d, md_temperature_3d = mod.get_md_temperature(source = source_cut, mass = mass, piston_velocity = 0.0)
